...
public class WednesdayActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        temperature.add(new Weather(R.drawable.partly_cloudy_day,"14","15"+degrees));
        temperature.add(new Weather(R.drawable.stormy_weather,"14"+degrees,"15"+degrees));
        temperature.add(new Weather(R.drawable.rain,"14"+degrees,"15"+degrees));
        temperature.add(new Weather(R.drawable.sunny,"14"+degrees,"15"+degrees));
